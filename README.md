...
| [`docs/knowledge-design/wiki.md`](docs/knowledge-design/wiki.md) | 对象 Purpose、Schema、Raw、Wiki、Memory、证据、日志和恢复合同 |
| [`docs/data-design/data_design.md`](docs/data-design/data_design.md) | 数据源、主动摄取调度、研究资料、配置和 CRUD 合同 |
...
| Evidence and knowledge | Implementation not established | `docs/knowledge-design/wiki.md` | Not established; wait for plan confirmation |
| Agent integration | Implementation not established | `docs/flow_design.md`, `docs/research-design/research_design.md` | Not established; wait for plan confirmation |
...
| `/Users/apple/ts/src/llm-wiki` | Source、Schema、摄取、关系、日志、检查和增量维护参考 |
...
持久化边界：接口数据按需获取；SQLite 保存对象、关注、事件、数据源和上传资料等产品元数据；文件仓库存储 Purpose、Schema、Raw、Wiki、Memory 和日志；Git 提供本地 checkpoint 和恢复，不执行自动 push。细节见 [`docs/data-design/data_design.md`](docs/data-design/data_design.md) 与 [`docs/knowledge-design/wiki.md`](docs/knowledge-design/wiki.md)。
